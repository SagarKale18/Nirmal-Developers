...
// // Adjust this relative path if your images folder structure is different
// import dayalNagriLogo from '../assets/images/DayalNagri.jpg';

// export default function DayalNagari() {
//   const navigate = useNavigate();

//   // Extracted project amenities from the provided image
//   const amenities = [
...
//             </div>
//             <div>
//               <h1 className="font-display text-2xl font-bold tracking-wide text-dark">Dayal Nagari</h1>
...
//        {/* Left Column: Image now completely covers the container block */}
...
//   <div className="absolute top-0 left-0 w-2 h-full bg-teal z-10"></div>
  
//   <img 
//     src={dayalNagriLogo} 
//     alt="Dayal Nagari Brand Showcase" 
//     className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-500"
//   />
// </div>

//           {/* Right Column: Project Copy Information */}
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              {/* CONNECTED BUTTON: Uses dynamic navigation */}
              <button 
