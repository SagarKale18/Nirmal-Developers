...
// // Adjust this path if your images directory structure varies
// import padmavatiGreenCityImg from '../assets/images/PadmavatiGreenCity.jpg';

// export default function PadmavatiGreenCity() {
//   const navigate = useNavigate();

//   // Maintaining standard premium development amenities extracted across the real estate project series
//   const amenities = [
...
//           {/* Identity update for Padmavati Green City */}
...
//             </div>
//             <div>
//               <h1 className="font-display text-2xl font-bold tracking-wide text-dark">Padmavati Green City</h1>
...
//           {/* Left Column: Replaced Text Structure Layout with full-bleed Image Showcase */}
...
//             {/* Elegant deep green theme left accent bar */}
//             <div className="absolute top-0 left-0 w-2 h-full bg-green-600 z-10"></div>
            
//             <img 
//               src={padmavatiGreenCityImg} 
//               alt="Padmavati Green City Master Layout" 
//               className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-500"
//             />
//           </div>

//           {/* Right Column: Project Copy Information updated for Padmavati Green City */}
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              {/* CONNECTED BUTTON: Programmatic push to routing context */}
              <button 
